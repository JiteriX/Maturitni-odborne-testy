...
export const QUESTIONS_STT_FILTERED: Question[] = QUESTIONS_STT.filter(q => ![241, 242, 244, 256, 296, 376, 401, 406, 409, 411, 412, 413, 426, 433, 450, 453, 467, 473, 484, 489, 490, 491, 492, 511, 512, 519, 529, 677, 689].includes(q.id));
