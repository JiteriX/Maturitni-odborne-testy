...
export const QuestionCard: React.FC<Props> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-3xl mx-auto mb-6">
      ...
      {((question.id === 224) || (question.id === 422 && subject === 'SPS') || (question.id === 253 && subject === 'SPS') || (question.id === 254 && subject === 'SPS') || (question.id === 274 && subject === 'STT') || (question.id === 285 && subject === 'STT') || (question.id === 286 && subject === 'STT') || (question.id === 309 && subject === 'STT') || (question.id === 492 && subject === 'STT') || (question.id === 511 && subject === 'STT') || (question.id === 677 && subject === 'STT') || (question.id === 680 && subject === 'STT')) && (showFeedback || mode === AppMode.REVIEW || (selected !== null && mode !== AppMode.MOCK_TEST)) && (
