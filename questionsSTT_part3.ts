...
export const part3 = [
  ...
  [505, "Na obrázku je stroj pro obrábění ultrazvukem. Vyber tvrzení, které správně popisuje jeho části:", ["1-generátor ultrazvukových kmitů, 2-převodník (magnetostrikce) + držák nástroje 3-zařízení pro přívod+odvod brusiva v suspenzi, 4-obrobek, 5-nástroj", "1-generátor mechanických kmitů...", "1-zdroj mechanických kmitů...", "1-generátor ultrazvukových kmitů..."], 0],
  [506, "Pro obrábění pomocí ultrazvuku se používá:", ["2 nástroje: jeden nástroj, který má pozitivní tvar...", "2 nástroje: jeden nástroj, který má negativní tvar opracované plochy, druhý nástroj který tvoří brusivo v suspenzi kapaliny", "1 nástroj...", "2 nástroje..."], 1],
  [507, "Pro obrábění pomocí ultrazvuku se požívá brusivo, které:", ["brusivo je pojené...", "brusivo je pojené...", "brusivo je volné a je v suspenzi vody v poměru cca 40% brusiva/60% kapaliny", "brusivo je volné..."], 2],
  [508, "Při opracování ultrazvukem se využívá dějů:", ["disociace...", "eroze materiálu způsobená kavitací...", "eroze materiálu díky kmitání brusných zrn vysokou frekvencí, za současného působení kavitace praskajícíh bublinek v kapalině...", "chemické..."], 2],
